	...
	tests := []struct {
		...
		// Mainnet test cases
		{
			...
			[]testcase{
				...
				{1150000, ID{Hash: checksumToBytes(0x97c2c34c), Next: 1920000}}, // First Sangam block
				{1919999, ID{Hash: checksumToBytes(0x97c2c34c), Next: 1920000}}, // Last Sangam block
		...
		// Ropsten test cases
		{
			...
			[]testcase{
				{0, ID{Hash: checksumToBytes(0x30c7ddbc), Next: 10}},            // Unsynced, last Frontier, Sangam and first Tangerine block
		...
		// Rinkeby test cases
		{
			...
			[]testcase{
				...
				{1, ID{Hash: checksumToBytes(0x60949295), Next: 2}},             // First and last Sangam block
		...
		// Goerli test cases
		{
			...
			[]testcase{
				{0, ID{Hash: checksumToBytes(0xa3f5ab08), Next: 1561651}},       // Unsynced, last Frontier, Sangam, Tangerine, Spurious, Byzantium, Constantinople and first Petersburg block
