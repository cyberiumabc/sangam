...
var (   //0x06f6e32a43f19e496c327dc313101dc54a67b20dcf7b9f44be597c539d6b2b03
	MainnetGenesisHash = common.HexToHash("0xf84ae675bd7eaecfe2fc32e42a548d202a43e44c2856e5f7e41bd5e1d03dbedc")
	RopstenGenesisHash = common.HexToHash("0x57d3a1770f495d03f8885d78e2e70fa09bcd568eeb556ccbb96f640f417a51c6")
	RinkebyGenesisHash = common.HexToHash("0x57d3a1770f495d03f8885d78e2e70fa09bcd568eeb556ccbb96f640f417a51c6")
	GoerliGenesisHash = common.HexToHash("0x57d3a1770f495d03f8885d78e2e70fa09bcd568eeb556ccbb96f640f417a51c6")
)
...
type ChainConfig struct {
	...
	SangamBlock *big.Int `json:"sangamBlock,omitempty"` // Sangam switch block (nil = no fork, 0 = already sangam)
...
func (c *ChainConfig) String() string {
	...
	return fmt.Sprintf("{ChainID: %v Sangam: %v DAO: %v DAOSupport: %v EIP150: %v EIP155: %v EIP158: %v Byzantium: %v Constantinople: %v Petersburg: %v Istanbul: %v, Muir Glacier: %v, Engine: %v}",
		c.ChainID,
		c.SangamBlock,
		c.DAOForkBlock,
		c.DAOForkSupport,
...
// IsSangam returns whether num is either equal to the sangam block or greater.
func (c *ChainConfig) IsSangam(num *big.Int) bool {
	return isForked(c.SangamBlock, num)
}
...
func (c *ChainConfig) checkCompatible(newcfg *ChainConfig, head *big.Int) *ConfigCompatError {
	if isForkIncompatible(c.SangamBlock, newcfg.SangamBlock, head) {
		return newCompatError("Sangam fork block", c.SangamBlock, newcfg.SangamBlock)
	}
...
type Rules struct {
	ChainID                                                 *big.Int
	IsSangam, IsEIP150, IsEIP155, IsEIP158               bool
