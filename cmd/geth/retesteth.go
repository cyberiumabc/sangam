...
type CParamsParams struct {
	...
	SangamForkBlock         *math.HexOrDecimal64  `json:"sangamForkBlock"`
...
func (api *RetestethAPI) SetChainParams(ctx context.Context, chainParams ChainParams) (bool, error) {
	...
	if chainParams.Params.SangamForkBlock != nil {
		sangamBlock = big.NewInt(int64(*chainParams.Params.SangamForkBlock))
	}
