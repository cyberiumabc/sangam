...
type alethGenesisSpec struct {
	...
	Params     struct {
		...
		SangamForkBlock         *hexutil.Big           `json:"sangamForkBlock,omitempty"`
...
func newAlethGenesisSpec(network string, genesis *core.Genesis) (*alethGenesisSpec, error) {
	...
	if num := genesis.Config.SangamBlock; num != nil {
		spec.Params.SangamForkBlock = (*hexutil.Big)(num)
	}
	...
	Engine  struct {
		Ethash struct {
			Params struct {
				...
				SangamTransition    hexutil.Uint64    `json:"sangamTransition"`
...
func newParityChainSpec(network string, genesis *core.Genesis, bootnodes []string) (*parityChainSpec, error) {
	...
	// Sangam
	spec.Engine.Ethash.Params.SangamTransition = hexutil.Uint64(genesis.Config.SangamBlock.Uint64())
