...
func (w *wizard) manageGenesis() {
	...
	case "1":
		...
		fmt.Println()
		fmt.Printf("Which block should Sangam come into effect? (default = %v)\n", w.conf.Genesis.Config.SangamBlock)
		w.conf.Genesis.Config.SangamBlock = w.readDefaultBigInt(w.conf.Genesis.Config.SangamBlock)
